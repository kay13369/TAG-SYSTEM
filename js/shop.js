...
(function () {
  ...
  const PRODUCTS = [
    ...
    { id: "m365", name: "Microsoft 365 Business", cat: "Software & Licences", icon: "☁️", price: 1200, desc: "Per user / year — Office apps, Exchange, Teams and OneDrive." },
    { id: "kaspersky", name: "Kaspersky Endpoint Security", cat: "Software & Licences", icon: "🛡️", price: 450, desc: "Per device / year — next-gen endpoint protection and monitoring." },
    { id: "adobe-cc", name: "Adobe Creative Cloud", cat: "Software & Licences", icon: "🎨", price: 9800, desc: "Per user / year — the full Creative Cloud suite for your team." },
